...
// Init the browser name anyhow
const browser = process.env.BROWSER || 'chrome';

// Create only one folder to store reports and error shots for each process
if (!process.env.FOLDER_NAME) {
  process.env.FOLDER_NAME = moment().format();
}
...
exports.config = {
  ...
  capabilities: [{
    ...
    maxInstances: 5,
    //
    browserName: browser, // options: chrome || firefox || phantomjs
  }],
  //
  // ===================
  // Test Configurations
  ...
  screenshotPath: `./reports/${process.env.FOLDER_NAME}/errorShots/`,
  //
  ...
  reporterOptions: {
    outputDir: `./reports/${process.env.FOLDER_NAME}`,
  },
  //
